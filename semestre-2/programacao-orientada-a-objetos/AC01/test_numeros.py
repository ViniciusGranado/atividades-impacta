    ...
    if os.path.exists(arq):
        with open(arq, 'r') as f:
            ...
            if "import " in conteudo:
                raise Exception('Erro: o arquivo "numeros.py" não pode importar bibliotecas externas!')
            elif "input(" in conteudo:
                raise Exception('Erro: o arquivo "numeros.py" não pode usar o comando input(). Você não deve ler entradas do usuário diretamente. Você só pode usar os valores passados por parâmetro para as funções.')
...
# --------------------------------------------------------------------- #
print_cabecalho("função conta_primos")
d = numeros.conta_primos([1, 4, 8, 10])
resposta_esperada = {}
print('resposta obtida:  ', d)
print('resposta esperada:', resposta_esperada)
print('os dicionários são iguais?', d == resposta_esperada)
...
# --------------------------------------------------------------------- #
print_cabecalho("função conta_primos")
d = numeros.conta_primos((111, 191, 202, 306, 239, 579))
resposta_esperada = {191: 1, 239: 1}
print('resposta obtida:  ', d)
print('resposta esperada:', resposta_esperada)
print('os dicionários são iguais?', d == resposta_esperada)
